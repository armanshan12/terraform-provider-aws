...
func resourceAwsCloudWatchMetricAlarmActionAttachment() *schema.Resource {
	return &schema.Resource{
		Create: resourceAwsCloudWatchMetricAlarmActionAttachmentCreate,
		Read:   resourceAwsCloudWatchMetricAlarmActionAttachmentRead,
		Update: resourceAwsCloudWatchMetricAlarmActionAttachmentUpdate,
		Delete: resourceAwsCloudWatchMetricAlarmActionAttachmentDelete,
...
func resourceAwsCloudWatchMetricAlarmActionAttachmentCreate(d *schema.ResourceData, meta interface{}) error {
...
func resourceAwsCloudWatchMetricAlarmActionAttachmentRead(d *schema.ResourceData, meta interface{}) error {
...
func resourceAwsCloudWatchMetricAlarmActionAttachmentUpdate(d *schema.ResourceData, meta interface{}) error {
	conn := meta.(*AWSClient).cloudwatchconn
	params := getAwsCloudWatchPutMetricAlarmInput(d)
...
func resourceAwsCloudWatchMetricAlarmActionAttachmentDelete(d *schema.ResourceData, meta interface{}) error {
